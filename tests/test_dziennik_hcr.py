...
'wychowanie fizyczne', 'oceny': [6, 6]}], 'uwagi': [{'uwaga': 'nieprzygotowanie'}]}],
	...
	def test_eksportuj_dane_zly_format_pliku(self):
		assert_that(calling (self.temp.eksportuj_dane).with_args('sdfsf'),raises(ValueError))
	...
	def test_eksportuj_dane_zly_format_pliku_3(self):
		assert_that(calling (self.temp.eksportuj_dane).with_args(3),raises(ValueError))

	def test_eksportuj_dane_zly_format_pliku_4(self):
		assert_that(calling (self.temp.eksportuj_dane).with_args('dfsdf.mp3'),raises(ValueError))
...
'wychowanie fizyczne', 'oceny': [6, 6]}], 'uwagi': [{'uwaga': 'nieprzygotowanie'}]}]))
    ...
    def tearDown(self):
        self.temp = None
>>>>>>> ffaec83faf79da8f81b92d5deae9d53d0d59cb9f
